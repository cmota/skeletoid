...
object ThreadPoolUtils {
     ...
     */
    @JvmStatic
    fun getFixedThreadPool(threadPoolName: String, MAX_THREAD: Int): java.util.concurrent.ThreadPoolExecutor {
        return ThreadPoolExecutor(MAX_THREAD, MAX_THREAD, 0L,
                TimeUnit.MILLISECONDS, NamedThreadFactory(threadPoolName,
                MAX_THREAD))
    }
     ...
     */
    @JvmStatic
    fun getScheduledThreadPool(threadPoolName: String, MAX_THREAD: Int): ScheduledThreadPoolExecutor {
        return ScheduledThreadPoolExecutor(MAX_THREAD,
    ...
    fun shutdown(threadPoolExecutor: java.util.concurrent.ThreadPoolExecutor?) {
        ...
        threadCount.addAndGet(-threadPoolExecutor.corePoolSize)
